...
@section('content')
    <style>
        ...
        /* UPLOAD BOX STYLING & FILE BADGES */
        .upload-zone {
    ...
    <div class="form-container">
        ...
        <div class="page-header-container">
            <div class="header-title-group">
                <h1>Edit Produk Buku</h1>
                <p>Perbarui rincian informasi dan spesifikasi katalog buku ini.</p>
            </div>
            ...
            <div class="card-modern">
                ...
                <div class="form-group-modern">
                    ...
                    <div class="format-selector-grid">
                        <label class="format-card-option {{ old('type', $book->type) == 'physical' ? 'active' : '' }}"
                            id="optionPhysical">
                            <input type="radio" name="type" value="physical"
                                {{ old('type', $book->type) == 'physical' ? 'checked' : '' }}
                        ...
                        <label class="format-card-option {{ old('type', $book->type) == 'ebook' ? 'active' : '' }}"
                            id="optionEbook">
                            <input type="radio" name="type" value="ebook"
                                {{ old('type', $book->type) == 'ebook' ? 'checked' : '' }} onchange="toggleFormat('ebook')">
                ...
                <div class="form-group-modern">
                    ...
                    <input type="text" name="title" class="input-modern" value="{{ old('title', $book->title) }}"
                ...
                <div class="grid-2">
                    <div class="form-group-modern">
                        ...
                        <input type="number" name="price" class="input-modern" value="{{ old('price', $book->price) }}"
                            placeholder="Contoh: 108000" required>
                    </div>
                    <div class="form-group-modern" id="stockGroup"
                        style="{{ old('type', $book->type) == 'ebook' ? 'display: none;' : '' }}">
                        <label class="form-label-modern">Jumlah Stok <span>*</span></label>
                        <input type="number" name="stock" class="input-modern" value="{{ old('stock', $book->stock) }}"
            ...
            <div class="card-modern">
                ...
                <div class="grid-2">
                    <div class="form-group-modern">
                        ...
                        <input type="text" name="isbn" class="input-modern" value="{{ old('isbn', $book->isbn) }}"
                ...
                <div class="grid-2">
                    ...
                    <div class="form-group-modern">
                        ...
                        <input type="number" name="pages" class="input-modern"
                            value="{{ old('pages', $book->pages) }}" placeholder="Contoh: 256">
                    </div>
                </div>
                ...
                <div class="grid-2">
                    <div class="form-group-modern">
                        ...
                        <input type="text" name="dimensions" class="input-modern"
                            value="{{ old('dimensions', $book->dimensions) }}" placeholder="Contoh: 15.5 x 23 cm">
                    </div>
                    <div class="form-group-modern">
                        <label class="form-label-modern">Berat Buku</label>
                        <input type="text" name="weight" class="input-modern"
                            value="{{ old('weight', $book->weight) }}" placeholder="Contoh: 350 gram">
                    </div>
                </div>
                ...
                <div class="grid-2">
                    ...
                    <div class="form-group-modern">
                        ...
                        <select name="cover_type" class="select-modern">
                            <option value="Soft Cover"
                                {{ old('cover_type', $book->cover_type) == 'Soft Cover' ? 'selected' : '' }}>Soft
                                Cover</option>
                            <option value="Hard Cover"
                                {{ old('cover_type', $book->cover_type) == 'Hard Cover' ? 'selected' : '' }}>Hard
                                Cover</option>
                        </select>
                    </div>
                </div>
            ...
            <div class="card-modern">
                ...
                <div class="grid-2">
                    ...
                    <div class="form-group-modern">
                        ...
                        <div class="upload-zone">
                            ...
                            <div class="upload-text-main">Pilih file foto baru jika ingin mengganti</div>
                        ...
                        @if ($book->cover_image)
                            <div class="current-file-badge">
                                <i class="fa-solid fa-image" style="color: #4F46E5;"></i> Sampul Aktif Ada
                            </div>
                        @endif
                    </div>

                    <!-- Ebook Upload Box (Digital Only) -->
                    <div class="form-group-modern" id="ebookFileGroup"
                        style="{{ old('type', $book->type) == 'ebook' ? 'display: block;' : 'display: none;' }}">
                        <label class="form-label-modern">File Digital E-Book (PDF)</label>
                        <div class="upload-zone">
                            <i class="fa-solid fa-file-pdf" style="color: #EF4444;"></i>
                            <div class="upload-text-main">Pilih file E-Book baru jika ingin mengganti</div>
                        ...
                        @if ($book->file_pdf)
                            <div class="current-file-badge">
                                <i class="fa-solid fa-paperclip" style="color: #EF4444;"></i> File Aktif:
                                {{ basename($book->file_pdf) }}
                            </div>
                        @endif
                    </div>
                </div>
                ...
                <div class="form-group-modern">
                    ...
                    <textarea name="description" rows="5" class="textarea-modern"
                        placeholder="Tuliskan sinopsis atau deskripsi buku di sini...">{{ old('description', $book->description) }}</textarea>
                </div>
            </div>
